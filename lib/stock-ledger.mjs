...
export function applyMovement(db, {
  ...
  // CATCH UP FIRST, IN EITHER DIRECTION.
  //
  ...
  // row the ledger has no movements for and it lands at -1. The reverse (a ledger ahead of its cache,
  // which a hand-edited database can produce) is squared by the same statement with a negative delta.
  //
