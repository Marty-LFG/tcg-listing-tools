...
export function renderPullList(groups = [], { orderCount = 0, itemCount = 0, unitCount = 0 } = {}) {
  ...
  if (!groups.length) return head + '\n\n<i>Nothing to pull — everything is packed.</i>';
...
export function renderDispatchSummary(orders = []) {
