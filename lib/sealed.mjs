...
export function summarizeSealed(rows, upcMap = new Map()) {
  ...
  // Unknown is not zero — the same counter summarizeInventory keeps, for the same reason: cents()
  // turns a missing cost into a 100% margin, and a barcode scan can create a row without one.
