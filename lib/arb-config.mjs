...
export function loadArbConfig() {
  try {
    ...
    return { ...ARB_DEFAULTS, ...c, watch: { ...ARB_DEFAULTS.watch, ...(c.watch || {}) }, sweep: { ...ARB_DEFAULTS.sweep, ...(c.sweep || {}) } };
  } catch (e) {
...
export function validateArbConfig(input) {
  ...
  const c = { ...input, watch: { ...ARB_DEFAULTS.watch, ...(input.watch || {}) }, sweep: { ...ARB_DEFAULTS.sweep, ...(input.sweep || {}) } };
