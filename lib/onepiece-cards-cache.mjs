  ...
  return {
    ...
    configureServer(server) {
      server.middlewares.use('/api/op/sets/card', async (req, res, next) => {
        ...
        // ?refresh=1 is the builders' refresh button: fetch the set again before answering, so a set
        // that gained cards (or moved on price) can be pulled without touching the disk by hand.
