...
import { readCache as readPkmSetsCache, findSet } from './pkm-sets-cache.mjs';
...
export function composeMetaFor(item = {}) {
  ...
  // The set's cached record carries the SYMBOL plus the era fields Golden Rule 10's formatter reads.
  // A cold cache or a set it does not know (JP, another game) simply means no symbol.
