  ...
  return async (req, res) => {
    try {
      ...
      if (p === '/picksheet' && method === 'GET') {
        // ids=<order_id,order_id,…> picks a hand-selected subset (dashboard tick boxes); otherwise the
        // whole status set (unshipped by default). Either way the pull list is grouped + ordered by BOX.
