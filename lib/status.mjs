...
import { getKeepersEngineState, shopMismatchProblem, validateKeepersConfig, startKeepersJobs, stopKeepersJobs } from './keepers.mjs';
...
export const SETTINGS = {
  ...
  'shopify-hooks': {
    ...
    validate: (c) => {
      ...
      return shopMismatchProblem(process.env, null, c);
    },
...
//
// A rejection spike is the ONLY warning that an app-secret rotation has silently killed every webhook.
