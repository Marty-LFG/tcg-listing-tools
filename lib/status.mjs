...
export const SETTINGS = {
  ...
  'ebay-listing': {
    ...
    normalize(c) {
      ...
      return { ...c, payments: pay, shipping: { ...s, minBandForSlab: Number.isInteger(s.minBandForSlab) ? s.minBandForSlab : DEFAULT_MIN_BAND_FOR_SLAB, bands: normalizeBands(s.bands) } };
    },
    validate(c) {
      if (!c || typeof c !== 'object') return 'not an object';
