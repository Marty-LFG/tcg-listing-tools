...
export const SETTINGS = {
  ...
  runs: {
    ...
    // Nothing holds a parsed copy: the router calls loadRunsConfig() per request precisely so an
    // arming change takes effect without a restart.
    apply() { return 'live-read — applies on the next runs request'; },
  },
