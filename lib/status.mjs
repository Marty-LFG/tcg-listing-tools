...
export const SETTINGS = {
  ...
  keepers: {
    ...
    validate(c) {
      ...
      //
      // SETTINGS.shopify below already gets this right for publish.allowLive, with the same reasoning
      // written out. This is that rule, applied to the second registry entry that needed it.
