...
export async function applyPlan(env, cfg, plan, { call = notifyCall } = {}) {
  ...
  for (const c of plan.create) {
    ...
    if (!id) { fail('createSubscription ' + c.topicId, { error: 'created, but eBay returned no subscriptionId and re-reading did not find it' }); continue; }
