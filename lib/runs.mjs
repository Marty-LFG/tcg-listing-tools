    ...
    try {
      ...
      if (run && tail === '/publish-product' && method === 'POST') {
        ...
        try {
          ...
          return send(res, 200, { ...out, availability: mirrorAvailability(db, run.id) });
        } catch (e) {
      ...
      if (run && tail === '/poll' && method === 'POST') {
        ...
        try {
          ...
          return send(res, 200, { ...out, available: availability(db, run.id).available, drift: availabilityDrift(db, run.id) });
