...
export async function runPass({ db, base, onlyId = null, trigger = 'schedule' } = {}) {
  ...
  try {
    ...
    if (onlyId == null) _lastPass = { started_at: started.toISOString(), finished_at: new Date().toISOString(), trigger, ok: false, error: String(e?.message || e), checked: null, snapshots: 0, errors: {} };
    throw e;
  }
}
