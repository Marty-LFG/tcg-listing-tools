...
export function printConfig(env) {
  ...
  return {
    ...
    // TSPL print speed (in/s). 2 mirrors the AUSPRINT vendor app's proven "Speed 2";
    // slower = crisper barcode edges. The client may override this per print request.
    speed: parseFloat(env.LABEL_PRINTER_SPEED || '2'),
