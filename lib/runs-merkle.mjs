...
import { ns, normalizeValue, toHex } from './runs-canonical.mjs';

const utf8 = new TextEncoder();

const HEX64 = /^[0-9a-f]{64}$/;
const bytes = (hex) => {
  if (!HEX64.test(hex)) throw new TypeError(`expected 32 bytes as 64 lowercase hex characters; got ${JSON.stringify(hex)}`);
