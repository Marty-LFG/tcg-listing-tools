...
function tokenFor(env, which) {
  return String((which === 'deletion' ? env.EBAY_NOTIFY_DELETION_TOKEN : env.EBAY_NOTIFY_VERIFICATION_TOKEN) || '').trim();
}
