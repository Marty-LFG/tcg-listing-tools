...
function migrateRuns(db) {
  db.exec(`
    ...
    -- ---- THE PUBLIC VIEWS. lib/runs-public.mjs is the only module allowed to build a customer-facing
    ...
    -- bundle changed.
    CREATE VIEW IF NOT EXISTS v_run_public_slot AS
    ...
    CREATE VIEW IF NOT EXISTS v_run_public_bundle AS
      SELECT id, run_id, bundle_no, label, leaf_hash FROM run_bundles;
    CREATE VIEW IF NOT EXISTS v_run_public_run AS
