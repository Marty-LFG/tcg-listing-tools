...
import { isSetId, cachePathFor, readCache, writeCache, hasCache, decideSetResponse, withInflight, fetchJsonRetry, sendJson, refreshIfPricesAreStale } from './set-cache.mjs';
  ...
  return {
    ...
    configureServer(server) {
      ...
      server.middlewares.use('/api/pkm/cards', (req, res, next) => {
        ...
        return send(res, 200, { data: hit.card }, 'disk');
      });
    },
  };
}
