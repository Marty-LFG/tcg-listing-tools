  ...
  return async (req, res) => {
    try {
      ...
      if ((m = p.match(/^\/items\/(\d+)$/)) && method === 'PATCH') {
        ...
        // Only the destructive shapes are guarded. Fixing a typo in the card name of a reserved item is
        // fine and common; selling it or shrinking it out from under the run is not.
