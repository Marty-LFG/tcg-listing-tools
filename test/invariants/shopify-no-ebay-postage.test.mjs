...
describe('the shared product wording is imported, not re-typed', () => {
  it('shopify-map.mjs takes its sentences from lib/listing-copy.mjs', () => {
    ...
    // line (A7, 2026-08-23).
    // CARD_PROTECTION, SLAB_PROTECTION and SHOPIFY_PROVENANCE left the Shopify description on
    // 2026-09-13: the theme's trust rows say the parcel and the tagline on the same page, so the
    // description carries the picture line only.
    for (const k of ['SHOPIFY_CATALOGUE_ART']) {
